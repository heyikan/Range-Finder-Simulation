classdef selectedObj
    ...
    properties
        ...
        allType % Sensörden gelen tüm ýþýnlarýn deðdiði objenin hangisi olduðunu depolandýðý deðiken
        figureWindow % Seçili Robot için oluþturulan figure penceresinin adresini tutan deðiþken
 
        pressedButton % Panele eleman eklemek için gerekli tuþ komninasyonlarýný tutan deðiþken
